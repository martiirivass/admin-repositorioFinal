      ...
      <div className="w-full max-w-[500px] h-full bg-surface-container shadow-2xl border-l border-outline-variant flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto px-xl py-xl space-y-xl custom-scrollbar">
          ...
          <div className="grid gap-lg">
            ...
            <div className="space-y-xs">
              <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider font-semibold">Descripci&oacute;n</label>
              <textarea
                value={descripcion}
          ...
          <div className="space-y-xs">
            <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider font-semibold">Categor&iacute;as</label>
