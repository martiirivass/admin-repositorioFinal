...
import { usePagos, useCrearPago } from "../hooks/usePagos";
import { useFormasPago } from "../hooks/useFormaPago";
import { formatARS } from "../../../shared/currency";

export function PagosPage() {
  const [pedidoFilter, setPedidoFilter] = useState<number | undefined>(undefined);
  ...
  return (
    <div>
      <header className="flex justify-between items-center mb-2xl">
        <div>
          <h2 className="font-headline-lg text-headline-lg text-on-surface">Gestión de Pagos</h2>
