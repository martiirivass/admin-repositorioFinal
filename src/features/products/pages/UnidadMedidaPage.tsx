...
import { useUnidadesMedida, useCrearUnidadMedida, useActualizarUnidadMedida, useEliminarUnidadMedida } from "../hooks/useUnidadMedida";
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-surface-container border border-outline-variant rounded-lg p-lg mb-lg flex flex-col md:flex-row gap-md items-end shadow-md">
        ...
        <div className="space-y-xs min-w-[100px]">
          <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">Símbolo</label>
        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-surface-container-high border-b border-outline-variant">
            <tr>
              ...
              <th className="px-lg py-md font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider">Símbolo</th>
