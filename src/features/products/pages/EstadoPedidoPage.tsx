import { useEstadosPedido } from "../hooks/useEstadoPedido";
...
const ESTADOS_MAP: Record<string, { color: string }> = {
  ...
  EN_CAMINO: { color: "bg-purple-900/30 text-purple-400 border-purple-400/20" },
  ...
  return (
    <div>
      <header className="mb-2xl">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant mt-xs">Catálogo de estados posibles para los pedidos.</p>
      </header>
